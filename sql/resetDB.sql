-- Host: localhost
-- Generation Time: Oct 21, 2009 at 08:31 AM
...
DROP TABLE IF EXISTS `_seq_bug_id`;
...
DROP TABLE IF EXISTS `_seq_priority_id`;
...
DROP TABLE IF EXISTS `_seq_project_id`;
...
DROP TABLE IF EXISTS `_seq_pr_us_id`;
...
DROP TABLE IF EXISTS `_seq_response_id`;
...
DROP TABLE IF EXISTS `_seq_user_id`;
